...
print('Alice send: ' + message)
print('Alice signature: ' + signature.hex())
...
print('Message excahange, public key: ' + bob_received_public_key)
...
print('Bob signature: ' + signature.hex())
...
print('Message excahange, public key: ' + alice_received_public_key)
