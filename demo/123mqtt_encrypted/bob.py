...
def send_periodic_message():
    ...
    if (shared_secret == ''):
        ...
        client.publish("public-data/Silly-Headrest-2013/Old-Engine-6372/message", "hello Alice!", 2)
    else:
        ...
        client.publish("public-data/Silly-Headrest-2013/Old-Engine-6372/message", encrypted_text_hex, 2)
