...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("public-data/+/Old-Engine-6372/request")
    client.subscribe("public-data/+/Old-Engine-6372/publickey")
    client.subscribe("public-data/+/Old-Engine-6372/message")

    # subscribe to private channel (sub-topic allowed)
    # topic: <username>/#
    client.subscribe("Old-Engine-6372/#")

def on_message(client, userdata, msg):
    global shared_secret
    print(msg.topic + ': ' + msg.payload.decode())
    received = list(unpack_topic('public-data/+/Old-Engine-6372/#', msg.topic))
    print(received)
    sender = received[0]
...
def update_public_shared_secret():
    ...
    print(time.ctime())
    client.publish("public-data/Old-Engine-6372/Silly-Headrest-2013/request", "publickey", 2)
